    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
				...
				<?php
					foreach($user AS $u){
					echo form_open('user/update', 'POST');
				?>
				<fieldset>
					<div class="form-group">
						<input type="hidden" name="id_user" value="<?php echo $u->id_user ?>">
						<label>NIP</label>
						<input class="form-control" value="<?php echo $u->nip ?>"  name="nip" type="text" autofocus>
					</div>
					<div class="form-group">
						<label>Nama</label>
						<input class="form-control" value="<?php echo $u->nama ?>"  name="nama" type="text" autofocus>
					</div>
					<div class="form-group">
						<label>Jenis Kelamin</label>
						<input class="form-control" value="<?php echo $u->jk ?>"  name="jk" type="text" autofocus>
					</div>
					<div class="form-group">
						<label>Jabatan</label>
						<input class="form-control" value="<?php echo $u->jabatan ?>"  name="jabatan" type="text" autofocus>
					</div>
					<div class="form-group">
						<label>Telp.</label>
						<input class="form-control" value="<?php echo $u->telp ?>"  name="telp" type="text" autofocus>
					</div>
					<div class="form-group">
						<label>E-mail/Username</label>
						<input class="form-control" value="<?php echo $u->username ?>"  name="username" type="text" autofocus>
					</div>
					<div class="form-group">
						<label>Password</label>
						<input class="form-control" value="<?php echo $u->password ?>"  name="password" type="password" autofocus>
					</div>
					<?php
